  ...
  return (
    ...
    <BrieBlasterPage>
      ...
      <div className="space-y-6">
        ...
        <p>
          3. MAKE SURE THE ANTENNA IS PLUGGED INTO THE HiV PORT.
        </p> 

        <br/>
        <h3>
          INSERTING NO ANTENNA OR A BROKEN ONE WILL CERTAINLY<br/>SHORT CIRCUIT THE ELECTRONICS AND DESTROY THIS LAPTOP.
        </h3>
        <br/>
        <p>
